...
class courseprogressblock extends block_base {
    ...
    public function get_data($params = false) {
        ...
        if (!$response = $cache->get($cachekey)) {
            ...
            $response->data = self::get_completion_with_percentage($course, $enrolledstudents, $cohortid, $returncompleted);
     ...
     */
    public static function get_completion_with_percentage($course, $users, $cohortid, $returncompleted = false) {
