...
class utility {
    ...
    /**
     * Get visits on lms graph data using filter.
     *
     * @param Object $data Data object
     *
     * @return Object
     */
    public static function get_studentengagement_visitsonlms_graph_data($data) {
        $studentengagement = new \local_edwiserreports\studentengagementblock();
        return $studentengagement->get_visitsonlms_graph_data($data->filter);
    }

    /**
     * Get timespent on lms graph data using filter.
     *
     * @param Object $data Data object
     *
     * @return Object
     */
    public static function get_studentengagement_timespentonlms_graph_data($data) {
        $studentengagement = new \local_edwiserreports\studentengagementblock();
        return $studentengagement->get_timespentonlms_graph_data($data->filter);
    }

    /**
     * Get timespent on course graph data using filter.
     *
     * @param Object $data Data object
     *
     * @return Object
     */
    public static function get_studentengagement_timespentoncourse_graph_data($data) {
        $studentengagement = new \local_edwiserreports\studentengagementblock();
        return $studentengagement->get_timespentoncourse_graph_data($data->filter);
    }
     ...
     * @return Object
     */
    public static function get_studentengagement_courseactivitystatus_graph_data($data) {
        $studentengagement = new \local_edwiserreports\studentengagementblock();
        return $studentengagement->get_courseactivitystatus_graph_data($data->filter);
    }

    /**
     * Get student engagement table data using filter.
     *
     * @param Object $data Data object
     *
     * @return Object
     */
    public static function get_studentengagement_table_data($data) {
        $studentengagement = new \local_edwiserreports\studentengagementblock();
        return $studentengagement->get_table_data($data->filter);
    }

    /**
     * Get course progress graph data using filter.
     *
     * @param Object $data Data object
     *
     * @return Object
     */
    public static function get_learner_courseprogress_graph_data($data) {
        $learner = new \local_edwiserreports\learnerblock();
        return $learner->get_courseprogress_graph_data($data->filter);
    }
     ...
     * @return Object
     */
    public static function get_learner_timespentonlms_graph_data($data) {
        $learner = new \local_edwiserreports\learnerblock();
        return $learner->get_timespentonlms_graph_data($data->filter);
    }
     ...
     * @return Object
     */
    public static function get_learner_table_data($data) {
        $learner = new \local_edwiserreports\learnerblock();
        return $learner->get_table_data($data->filter);
    }
