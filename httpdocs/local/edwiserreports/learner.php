...
// Check capability.
$capname = 'report/edwiserreports_learnerblock:view';
...
// Page URL.
$pageurl = new moodle_url($CFG->wwwroot . "/local/edwiserreports/learner.php");
...
$PAGE->requires->js_call_amd('local_edwiserreports/learner', 'init');

// Get renderable for coourse completion page.
$renderable = new \local_edwiserreports\output\learner_renderable();
$output = $PAGE->get_renderer($component)->render($renderable);

$PAGE->set_heading(get_string("learnerheader", "local_edwiserreports"));
$PAGE->set_title(get_string("learnerheader", "local_edwiserreports"));
